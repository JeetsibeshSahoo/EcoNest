    ...
    <main className="bg-white">
      <section className="py-8 sm:py-12">
        <Container>
          <Link
            to="/products"
            className="mb-10 inline-flex items-center gap-2 rounded-sm text-sm font-medium text-gray-600 transition-colors hover:text-[#173F35] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#173F35] focus-visible:ring-offset-2"
          >
            <ArrowLeft
              size={16}
              aria-hidden="true"
              ...
              <div className="mt-6">
                <button
                  ...
                  className={`w-full rounded-full px-6 py-3.5 text-sm font-medium text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 sm:w-auto ${
                    isAdded
                      ? "bg-[#2F6B5B] focus-visible:ring-[#2F6B5B]"
                      : "bg-[#173F35] hover:bg-[#122F29] focus-visible:ring-[#173F35]"
                  }`}
                >
                  {isAdded
                    ? "Added to cart ✓"
